...
if (!Context::page()->isAdmin())
    return;
echo '<div class="navigation-frame navigation-frame--stateless" id="meta-raw-data-editor">';
echo '<h2>Raw data</h2>';
Notifications::printWarningHTML('<strong>Warning:</strong> this tool can permanently delete data, and may put pages into unknown states that produce errors. Use with caution.');
