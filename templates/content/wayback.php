...
<p>
    <a href="<?php echo $wb->wbURL(); ?>" class="button button--inverted">View archived copy of <code style='color:inherit;background:transparent;'><?php echo $wb->originalURL(); ?></code></a><br>
    <small>
